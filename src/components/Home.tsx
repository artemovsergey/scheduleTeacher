...
import { ScheduleDay } from "./ScheduleByDay";
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <button
            onClick={jumpToToday}
            className={`w-full sm:w-auto px-4 py-2 rounded-lg font-medium transition-colors flex items-center justify-center ${
              currentWeek === todayInfo.week && activeDay === todayInfo.day
            ...
            {[1, 2, 3, 4, 5].map(day => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 min-w-[140px] md:min-w-0 md:flex-1 py-3 px-2 md:px-4 flex flex-col items-center justify-center transition-all ${
                    isActive 
